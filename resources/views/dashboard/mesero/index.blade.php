                    ...
                    <div class="p-4 bg-neutral-50 dark:bg-neutral-700/50 rounded-lg border border-neutral-200 dark:border-neutral-600">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-xs px-2 py-1 rounded-full
                                @if($order->status === 'abierta') bg-gray-100 text-gray-700
                                @elseif($order->status === 'en_proceso') bg-blue-100 text-blue-700
                                @elseif($order->status === 'completada') bg-green-100 text-green-700
                                @elseif($order->status === 'cancelada') bg-red-100 text-red-700
                                @endif">
