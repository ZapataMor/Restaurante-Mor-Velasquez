<x-layouts.app :title="__('Editar Usuario')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 max-w-3xl mx-auto">
        ...
        <!-- Header -->
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold">Editar Usuario</h1>
            <p class="text-neutral-600 dark:text-neutral-400 mt-1">Actualiza la información de {{ $user->name }}</p>
        </div>
            ...
            <form action="{{ route('users.update', $user) }}" method="POST" class="space-y-6">
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-blue-800 dark:text-blue-200">Información del usuario</p>
                            <p class="text-sm text-blue-700 dark:text-blue-300 mt-1">
                                Registrado: {{ $user->created_at->format('d/m/Y H:i') }}<br>
